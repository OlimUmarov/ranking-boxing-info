        ...
        <Grid container spacing={3}>
          <Grid item xs={12} md={5}>
            <Box sx={{ position: 'relative' }}>
              <Image src="/images/boxs/tayson.jpg" width={400} height={478} quality={97} alt="Feature img" />
              <Box
                sx={{
                  position: 'absolute',
                  top: -36,
              ...
              >
                ...
                <Box sx={{ mb: 2 }}>
                  ...
                  <BorderLinearProgress variant="determinate" color="inherit" value={10} order={2} />
                </Box>
                <Box sx={{ mb: 2 }}>
                  <Typography variant="subtitle1" color="text.secondary">
                    Нокауты
          ...
          <Grid item xs={12} md={7}>
            ...
            <Typography sx={{ color: 'text.secondary', mb: 2, ml: { xs: 0, md: 4 } }}>
              Майк Тайсон (род. 1966) - американский боксёр, который был известен своей непоколебимой силой и
              агрессивным стилем боя. Тайсон стал самым молодым чемпионом мира в супертяжёлом весе в истории бокса,
              выиграв титул в возрасте 20 лет. Он завоевал множество титулов и считается одним из наиболее ярких
              представителей этой категории веса.
            </Typography>
          </Grid>
        </Grid>
      </Container>
